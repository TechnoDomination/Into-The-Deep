...
public enum Positions {
    ...
    LeftSample2(new Vector2d(-60, -33.0), 0.0),
    ...
    Basket(new Vector2d(-48, -46),-PI*0.67),
    ...
    SpecimenObZoneTiny(new Vector2d(37, -54.5), PI * 0.5),
    StartingPosition(new Vector2d(8, -52), 0.0),
    ObserservationZoneParkingSpecimen(new Vector2d(50, -63), 0.0),
    ...
    HighRung2Test(new Vector2d(2, -40), 0.0),
    GoFrontTiny2SpecimenTest(new Vector2d(2, -25.5), 0.0),
